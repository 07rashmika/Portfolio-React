    ...
    <section className="w-full py-20">
      ...
      justify-center gap-4">
        <Card 
            ...
            description="We'll collabarte to map out your website's goals, target audience and
            , and key functionalities. We'll discuss things like site structure, navigation
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        font-bold group-hover/canvas-card:text-white text-center 
        group-hover/canvas-card:-translate-y-2 transition duration-200">
          {title}
        </h2>
        <h2 className="dark:text-white text-sm opacity-0 
        group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  
        font-bold group-hover/canvas-card:text-white text-center
        group-hover/canvas-card:-translate-y-2 transition duration-200 "
        style={{color:'#e4ecff'}}>
...
const AceternityIcon = ({order}: { order: string }) => {
  return (
    <div >
        <button className="relative inline-flex h-12 overflow-hidden rounded-full 
        p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 
        focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            justify-center rounded-full bg-slate-950 px-5 py-2 
             text-white backdrop-blur-3xl text-2xl font-bold">
                {order}
            </span>
        </button>
    </div>
